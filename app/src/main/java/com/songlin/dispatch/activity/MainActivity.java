...
import com.songlin.dispatch.fragment.MarketFragment;
import com.songlin.dispatch.fragment.OrderFragment;
import com.songlin.dispatch.fragment.IdiomFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.container, IdiomFragment.newInstance()).commitAllowingStateLoss();
...
//        bottomLayout.setTextColorResId(R.color.color_tab_text);
        bottomLayout.addTab(R.drawable.selector_movie, "成语", 0xff4a5965);
        bottomLayout.addTab(R.drawable.selector_music, "咨询", 0xff096c54);
        ...
        bottomLayout.setOnTabListener(new BottomNavigationBar.TabListener() {
            ...
            public void onSelected(BottomBarTab tab, int position) {
                ...
                switch (position) {
                    case 0:
                        fragment = IdiomFragment.newInstance();
                        break;
                    case 1:
...
//                        .setCustomAnimations(android.R.anim.fade_in, android.R.anim.fade_out)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            try {
                DBUtils.del(MainActivity.this, "user_name");
                DBUtils.del(MainActivity.this, "user_phone");
                DBUtils.del(MainActivity.this, "user_password");
