...
public class SignupActivity extends AppCompatActivity {
    ...
    public void onSignupSuccess() {
        ...
        try {
            DBUtils.put(this, "user_name", mNameText.getText().toString());
            DBUtils.put(this, "user_phone", mEmailText.getText().toString());
            DBUtils.put(this, "user_password", mPasswordText.getText().toString());
